...
;LastTime	SPACE 4		;store previous TImer value
...
LOOP2	LDR R2, [R0, R1]
	...
	; initialize pointers
      ...
      POP {R0-R4,PC}
;Debug capture 
; Number of instructions in Debug_Capture = 35
;Number of Cycles = 70 assuming 2 cycles per instruction
; Time for one iteration = 70*cycle time = 70*12.5ns=875ns
;6400000 cycles until next iteration = 0.08s
;intrusion %=0.00109375
Debug_Capture 		
      PUSH {R0-R6,LR}
; you write this
